...
//    private final static int OBSERVER_Z = 30;
    private final static int OBSERVER_X = 300;
    private final static int OBSERVER_Y = 300;
    private final static int OBSERVER_Z = 300;
    ...
    public static ObserverModel observerXOY = new ObserverModel(0, 0, 500, OBSERVER_FOV_X, OBSERVER_FOV_Y,
            OBSERVER_Y_ANGLE, OBSERVER_X_ANGLE, OBSERVER_Z_ANGLE);
    public static ObserverModel observerXOZ = new ObserverModel(0, 500, 0, OBSERVER_FOV_X, OBSERVER_FOV_Y,
            OBSERVER_Y_ANGLE, OBSERVER_X_ANGLE, OBSERVER_Z_ANGLE);
    public static ObserverModel observerYOZ = new ObserverModel(500, 0, 0, OBSERVER_FOV_X, OBSERVER_FOV_Y,
            OBSERVER_Y_ANGLE, OBSERVER_X_ANGLE, OBSERVER_Z_ANGLE);
...
//    public static LookAtModel lookAtPoint = new LookAtModel(-62, -98, 231, 0, 0, 0);
    public static LookAtModel lookAtPoint = new LookAtModel(50, 50, 300, 0, 0, 0);
